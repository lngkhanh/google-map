		...
		<div id="main">
			<div class="sidebar"
				...
				<div>
					<table>
						<tr>
							<td><input id="idLookup" type="text"
								placeholder="Enter a location"></td>
							<td><input id=btSearch type="image" src="images/Search.png"
								onclick="doSearch()"></td>
						</tr>
					</table>
				</div>
				...
				<div>
					<input id=btEdit type="image" src="images/lg1.png" onclick="initialize()">
					<input id=btEdit type="image" src="images/lg2.png" onclick="doEdit()"> 
					<input id=btEdit type="image" src="images/lg3.png" onclick="doTimer()">
				</div>
				<div>
